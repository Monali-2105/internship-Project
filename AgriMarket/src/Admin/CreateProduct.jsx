        ...
        <>
            ...
            <div className="create-product-container">
                ...
                onSubmit={createProductSubmit}>
                    ...
                    <input type="number" className="form-input" placeholder='Enter Product Price' required name='price'
                    ...
                    <input type="number" className="form-input" placeholder='Enter Product Stock' required name='stock'
